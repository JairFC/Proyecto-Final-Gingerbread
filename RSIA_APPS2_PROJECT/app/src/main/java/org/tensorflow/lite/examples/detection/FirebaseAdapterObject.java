 ...
 */
public abstract class FirebaseAdapterObject<ViewHolder extends RecyclerView.ViewHolder, T>
        extends RecyclerView.Adapter<ViewHolder> {

    private Query mQuery;
    private Class<ObjectDetected> mItemClass;
    private ArrayList<ObjectDetected> mItems;
     ...
     */
    public FirebaseAdapterObject(Query query, Class<ObjectDetected> itemClass) {
     ...
     */
    public FirebaseAdapterObject(Query query, Class<ObjectDetected> itemClass,
                                 @Nullable ArrayList<ObjectDetected> items,
        ...
        if (items != null && keys != null) {
            ...
            mItems = new ArrayList<ObjectDetected>();
    ...
    private ChildEventListener mListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                ObjectDetected item = (ObjectDetected) dataSnapshot.getValue(FirebaseAdapterObject.this.mItemClass);
                item.setName(key);
                ...
                if (previousChildName == null) {
                    ...
                    if (nextIndex == mItems.size()) {
                        mItems.add(item);
                        Collections.sort(mItems, new Comparator<ObjectDetected>() {
                            @Override
                            public int compare(ObjectDetected o1, ObjectDetected o2) {
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            if (mKeys.contains(key)) {
                ...
                ObjectDetected oldItem = mItems.get(index);
                ObjectDetected newItem = dataSnapshot.getValue(FirebaseAdapterObject.this.mItemClass);
        ...
        public void onChildRemoved(DataSnapshot dataSnapshot) {
            ...
            if (mKeys.contains(key)) {
                int index = mKeys.indexOf(key);
                ObjectDetected item = mItems.get(index);
        ...
        public void onChildMoved(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            int index = mKeys.indexOf(key);
            ObjectDetected item = dataSnapshot.getValue(FirebaseAdapterObject.this.mItemClass);
            mItems.remove(index);
            mKeys.remove(index);
            int newPosition;
            if (previousChildName == null) {
    ...
    protected FirebaseAdapterObject() {
    }
     ...
     */
    public ArrayList<ObjectDetected> getItems() {
        return mItems;
    }
     ...
     * @return the item
     */
    public ObjectDetected getItem(int position) {
     ...
     */
    public int getPositionForItem(ObjectDetected item) {
     ...
     */
    public boolean contains(ObjectDetected item) {
     ...
     */
    protected abstract void itemAdded(ObjectDetected item, String key, int position);
     ...
     */
    protected abstract void itemChanged(ObjectDetected oldItem, ObjectDetected newItem, String key, int position);
     ...
     */
    protected abstract void itemRemoved(ObjectDetected item, String key, int position);
     ...
     */
    protected abstract void itemMoved(ObjectDetected item, String key, int oldPosition, int newPosition);
